...
{
    class Espaldar:IGraficarObject
    {
        float x, y, z;
        Vector3 cm,color;
        bool state;

        public Espaldar(Vector3 CM)
        {
            this.state = false;
        ...
        void espaldar()
        {
            ...
            GL.Vertex3(cm.X - x, cm.Y + 3.5 * y - 6, cm.Z - z);
            GL.Vertex3(cm.X - x, cm.Y + 3.5 * y - 6, cm.Z + z);
            GL.Vertex3(cm.X - x, cm.Y + y - 6, cm.Z + z);
            GL.End();
            ...
            GL.Vertex3(cm.X - x + 2, cm.Y + y - 6, cm.Z - z);
            GL.Vertex3(cm.X - x + 2, cm.Y + 3.5 * y - 6, cm.Z - z);
            GL.Vertex3(cm.X - x + 2, cm.Y + 3.5 * y - 6, cm.Z + z);
            GL.Vertex3(cm.X - x + 2, cm.Y + y - 6, cm.Z + z);
            GL.End();
